...
def test_basic_functionality():
    points = homogenize_single_frame_points(np.array([[1, 2], [2, 4], [3, 6]]))
...
def test_edge_case_on_the_line():
    points = homogenize_single_frame_points(np.array([[1, 2], [2, 4], [3, 8]]))
...
def test_invalid_input():
    points = homogenize_single_frame_points(np.array([[1, 1], [2, 2]]))
...
def test_zero_denominator():
    points = homogenize_single_frame_points(np.array([[2, 2], [1, 1], [3, 3]]))
